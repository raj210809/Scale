...
const PaymentOptions = () => {
  ...
  const options = [
    { id: 1, label: "Google Pay", icon: "https://path/to/gpay-icon.png" },
    { id: 2, label: "PhonePe", icon: "https://path/to/phonepe-icon.png" },
    { id: 3, label: "Paytm", icon: "https://path/to/paytm-icon.png" },
    { id: 4, label: "UPI ID", icon: "https://path/to/upi-id-icon.png" },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      {selectedOption ===  4 && (
        <TextInput placeholder="Enter UPI ID" style={styles.input} />
      )}
